    ...
    <div class="comment-section">
        ...
        <form action="<?php $_SERVER['PHP_SELF'] ?>" method="post" class="comment-form">
            <div class="form-line">
                ...
                <input type="text" id="pseudo" placeholder="Pseudonyme" name="utilisateur" required maxlength="20">
            </div>
            ...
            <main>
                <section class="landing-page">
                    ...
                    <div class="landing-line">
                        <div class="landing-title" data-class="FadeIn" data-delay="400">
                            <h2>Le bestiaire</h2>
                            <p>Découvrez les créatures les plus redoutables des mondes sombres et impitoyables des
                                Souls-like.
                ...
                <section class="bestiary-zone">
                    <div class="research-and-filter">
                        ...
                        <!-- SVG ORDRE ALPHABETIC -->
                        <input type="checkbox" class="order" name="" id="order" <?php if($ordre == 'ASC') echo 'checked' ?>>
                        <label for="order" id="ordercheckbox">
                            <!-- ... -->
                        </label>
                        ...
                        <button class="filter">
                            ...
                            <div class="filter-menu">
                                ...
                                <label>
                                    <input type="checkbox" name="dark_souls2" checked>
                                    Dark Souls 2
                                </label>
                                <label>
                                    <input type="checkbox" name="dark_souls3" checked>
                                    Dark Souls 3
                                </label>
                                <label>
                                    <input type="checkbox" name="fallen" checked>
                                    Lords of the Fallen
                                </label>
                            </div>
                        </button>
                    ...
                    <h3>Godfrey The First Lord</h3>
                        ...
                        foreach ($entity as $mobs) {
                            ...
                            } else if ($mobs['idgame'] == "3") {
                                $bestiary .= "<div class='case dark_souls2' data-class='FadeIn' data-offset='150'>
                                            <a href='mobpage.php?nom=" . $mobs['nom'] . "&game=" . $mobs['game_name'] . "&editor=" . $mobs['editor'] . "&release=" . $mobs['release_date'] . "&region=" . $mobs['region'] . "&hp=" . $mobs['hp'] . "&id=" . $mobs['id_entity'] . "'>
                                                <img class='mob-img' src='../assets/img_bestiary/mobs/" . $mobs['id_entity'] . ".webp'
                                                alt='' loading='lazy'>
                                            </a>
                            ...
                            } else if ($mobs['idgame'] == "4") {
                                $bestiary .= "<div class='case dark_souls3' data-class='FadeIn' data-offset='150'>
                                            <a href='mobpage.php?nom=" . $mobs['nom'] . "&game=" . $mobs['game_name'] . "&editor=" . $mobs['editor'] . "&release=" . $mobs['release_date'] . "&region=" . $mobs['region'] . "&hp=" . $mobs['hp'] . "&id=" . $mobs['id_entity'] . "'>
                                                <img class='mob-img' src='../assets/img_bestiary/mobs/" . $mobs['id_entity'] . ".webp'
                                                alt='' loading='lazy'>
                                            </a>
                            ...
                            } else if ($mobs['idgame'] == "5") {
                                $bestiary .= "<div class='case fallen' data-class='FadeIn' data-offset='150'>
                                            <a href='mobpage.php?nom=" . $mobs['nom'] . "&game=" . $mobs['game_name'] . "&editor=" . $mobs['editor'] . "&release=" . $mobs['release_date'] . "&region=" . $mobs['region'] . "&hp=" . $mobs['hp'] . "&id=" . $mobs['id_entity'] . "'>
                                                <img class='mob-img' src='../assets/img_bestiary/mobs/" . $mobs['id_entity'] . ".webp'
                                                alt='' loading='lazy'>
                                            </a>
